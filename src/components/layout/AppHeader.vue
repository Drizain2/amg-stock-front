        ...
        <div class="relative">
          ...
          >
            ...
            <svg class="w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M5.293 7.293a1 1 0 011.414 0L10 10.58613.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414  01-4-4a1 1 0 010-1.414z"
              />
            </svg>
          </button>
          ...
          <Transition name="dropdown">
            ...
            >
              <RouterLink
                to="/profile"
                class="flex items-center gap-3 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors"
              ...
              >
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.512c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573-c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"
                  />
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
              ...
              <button type="button" class="menu-item text-danger-600 w-full" @click="handleLogout">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24">
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M17 1614-4m0 01-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"
                  />
                </svg>
                Déconnexion
              </button>
